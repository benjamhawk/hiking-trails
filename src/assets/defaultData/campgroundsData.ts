...
export const defaultCampgroundsData: Campground[] = [
  {
    title: 'Campground 1',
    description: 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nesciunt dicta vel hic natus, tempora expedita culpa dolorum laborum vero, quaerat reprehenderit minima magnam, corrupti a molestias! Laudantium rem quae obcaecati',
    properties: {
      id: 1,
